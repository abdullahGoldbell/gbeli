    ...
    <div className="bg-white rounded-lg p-4 shadow-sm border border-neutral-200 mb-4">
      <div className="flex flex-wrap items-center gap-3">
        <input
          ...
          className="flex-1 min-w-[200px] px-3 py-2 border border-neutral-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary"
        />
        ...
        <select
          ...
          className="px-3 py-2 border border-neutral-300 rounded-md text-sm bg-white focus:outline-none focus:ring-2 focus:ring-primary"
        >
        ...
        {showAdd && (
          <>
            <button
              onClick={onUpload}
              className="px-4 py-2 bg-charcoal-light text-white text-sm font-medium rounded-md hover:bg-charcoal transition-colors"
            >
              &#8593; Upload Excel
            </button>
            <button
              onClick={onAdd}
              className="px-4 py-2 bg-primary text-gb-ink text-sm font-medium rounded-md hover:bg-primary-dark transition-colors"
            >
              + Add Vehicle
            </button>
          </>
        ...
        {showExport && (
          <button
            onClick={onExport}
            className="px-4 py-2 bg-success text-white text-sm font-medium rounded-md hover:bg-success-dark transition-colors"
          >
            Export Excel
          </button>
        )}
